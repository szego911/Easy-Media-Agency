      ...
      <FooterContainer>
        <Row>
          <Column>
            ...
            <FooterLink href="#contact">Küldj Emailt!</FooterLink>
          </Column>
          <Column>
          ...
          <Column>
            ...
            <FooterLink href="./desktop_pc/adatvedelem.pdf">
              Impresszum és adatvédelem
            </FooterLink>
            <FooterLink href="tel:+36303167102">+36 30 31 67 102</FooterLink>
            <FooterLink href="mailto:info@easymediaagency.com">
              info@easymediaagency.com
            </FooterLink>
          </Column>
          <Column>
