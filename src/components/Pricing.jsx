...
const Pricing = () => {
  ...
  const packages = [
    ...
    return (
        <div  
        className="py-10 md:px-14 p-4 max-w-screen-2xl mx-auto" id="arak">
      <div className="text-center">
        <h2 className="md:text-5xl text-2xl font-extrabold text-white-900 mb-2">Here are all our plans</h2>
        <p className="text-secondary md:w-1/3 mx-auto">A simple paragraph is comprised of three major components. The which is often a declarative sentence.</p>
        {/*<div className="mt-16">
      ...
      className="grid sm:grid-cols-2 lg:grid-cols-3 grid-cols-1 gap-10 mt-20 md:w-11/12 mx-auto">
        {packages.map((pkg, index) => (
          <div key={index} className=" bg-purple py-10 md:px-6 px-4 rounded-lg shadow-3xl">
            <h3 className="text-3xl  font-bold text-center text-white">{pkg.name}</h3>
